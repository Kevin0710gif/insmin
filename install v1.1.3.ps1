...
if (-not (Test-Path "C:\install\install\server")) {
    mkdir C:\install\install\server
}
...
$Url9 = "https://drive.usercontent.google.com/download?id=1-0up91WEUighTG_io95Zd6gXUH6ZUE1Z&export=download&authuser=0&confirm=t&uuid=0d0d8f15-43cd-493c-9844-01582b78e7f4&at=AENtkXZX4M79tZaP3iBqyUqGo55o:1731155692435"
